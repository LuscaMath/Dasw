		...
		<div class="table-wrapper">
			<div class="table-title">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Adicionar Dispositivo</span></a>
					</div>
				</div>
			</div>
			...
			while ($result = mysqli_fetch_assoc($mysqliquery)) {
				...
				<tr>
					<td>
						<?php echo $result['dono']; ?>
					</td>
					<td>
						<?php echo $result['nomeDispositivo']; ?>
					</td>
					<td>
						<?php echo $result['modelo']; ?>
					</td>
					<td>
						<?php echo $result['serialKey']; ?>
					</td>
			...
			<form method="POST" action="insert.php" >
				...
				<div class="modal-body">					
					<div class="form-group">
						<label>Dono</label>
						<input type="text" name="dono" class="form-control" required>
					</div>
					<div class="form-group">
						<label>Nome do Dispositivo</label>
						<input type="text" name="nomeDispositivo" class="form-control" required>
					</div>
					<div class="form-group">
						<label>Modelo</label>
					...
					<div class="form-group">
						...
						<input type="text"  class="form-control" name="serialKey required>
					</div>					
				</div>
